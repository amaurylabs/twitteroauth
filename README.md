<p itemprop="description">This is only a fork of abraham/twitteroauth package, with intended support of some older php versions. Please do use the original package preferably. Use this at your own risk</p>
